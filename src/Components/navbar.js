...
const navbar = () => {
  return (
    <div>
          <div class="container-none bg-indigo-500">
              <nav class=" border-gray-200 px-2 mb-5 p-5">
                  <div class="container mx-auto flex flex-wrap items-center justify-between">
                      <Link to={'/'} class="flex">
                          ...
                          <span class="self-center text-lg text-white font-bold whitespace-nowrap">pixelR</span>
                      </Link>
                      ...
                      <div class="hidden md:flex justify-between items-center w-full md:w-auto md:order-1" id="mobile-menu-3">
                          <ul class="flex-col md:flex-row flex md:space-x-8 mt-4 md:mt-0 md:text-sm md:font-medium">
                              <li>
                                  <Link to={'/'} class="text-lg text-white  hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-blue-700 md:p-0" aria-current="page">Home</Link>
                              </li>
                              <li>
                                  <Link to={'/about'} class="text-lg text-white hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-blue-700 md:p-0">About</Link>
                              </li>
                              <li>
                                  <Link to={'/blog'} class="text-lg text-white hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-blue-700 md:p-0">Blog</Link>
                              </li>
                          </ul>
                      </div>
                  </div>
